...
#if VASFMC_GAUGE
    FMCGPSHandler *fmcGpsHandler() { return m_gps_handler; }
    FMCFCUHandler *fmcFcuHandler() { return m_fcu_handler; }
    FMCCDUHandler *fmcCduLeftHandler() { return m_cdu_left_handler; }
    FMCCDUHandler *fmcCduRightHandler() { return m_cdu_right_handler; }
