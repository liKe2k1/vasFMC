...
withfgfs {
    ...
    HEADERS += \
        fsaccess_fgfs.h \
        fsaccess_fgfs_base.h \
        fsaccess_fgfs_state.h \
        fsaccess_fgfs_io.h \
        fsaccess_fgfs_xmlprot.h \
        fsaccess_fgfs_tcas.h \
        fsaccess_fgfs_flightstatusmodel.h
           
    SOURCES += \
        fsaccess_fgfs.cpp \
        fsaccess_fgfs_state.cpp \
        fsaccess_fgfs_io.cpp \
        fsaccess_fgfs_xmlprot.cpp \
        fsaccess_fgfs_tcas.cpp \
        fsaccess_fgfs_flightstatusmodel.cpp 
}
